...
# Obtained by environment variables, or by such as“<your_AccessKeyId>”Replace with a real AccessKeyId and so on.
#
...
filepath = "/opt/backups/donex_db_backup/donex_db_backup_" + date_actual.date()
